...
const enTranslations = {
    ...
    dnsLeakProtectionDesc: "Block browser-side local DNS leaks. Keep Xray DoH off for remote proxy DNS resolution unless you need a fixed DoH resolver.",
    ...
    dnsLeakProtectionHint: "For DNS leak tests, keep Xray DoH off so domains are resolved by the remote proxy exit. Enabling DoH may show the DoH provider IP.",
