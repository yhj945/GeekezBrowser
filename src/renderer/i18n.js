...
const enTranslations = {
    ...
    profileNotesPlaceholder: "Workflow, business notes, non-sensitive reminders...",
    ...
    profileProxyCoreLabel: "Proxy Core",
    profileProxyCoreInherit: "Inherit global default",
    profileProxyCoreXray: "Force Xray",
    profileProxyCoreSingBox: "Force sing-box",
    ...
    dnsLeakProtectionTitle: "DNS Leak Protection",
    dnsLeakProtectionDesc: "Block browser-side local DNS leaks. Xray DoH only affects the Xray core; sing-box uses the DNS settings in Proxy Core.",
    dnsLeakProtectionSaved: "DNS leak protection settings saved",
    dnsLeakProtectionEnable: "Enable DNS leak protection",
    dnsLeakProtectionDisableQuic: "Disable QUIC",
    dnsLeakProtectionDisablePrefetch: "Disable DNS prefetch",
    dnsLeakProtectionBlockLocal: "Block browser local DNS when GeekEZ proxy is active",
    dnsLeakProtectionXrayDns: "Enable Xray DoH DNS (advanced)",
    dnsLeakProtectionDohServers: "DoH servers, one per line",
    dnsLeakProtectionHint: "Browser-side protections apply to both cores. The DoH list below is only written into Xray configs.",
    dnsLeakProtectionSingBoxHint: "Current default core is sing-box, so Xray DoH will not be used. Configure sing-box remote DNS servers in Proxy Core instead.",
    proxyCoreTitle: "Proxy Core",
    proxyCoreDesc: "Choose the proxy core used by newly launched profiles. Xray remains the compatibility default.",
    proxyCoreSaved: "Proxy core settings saved. Restart running profiles to apply changes.",
    proxyCoreSelectLabel: "Default proxy core",
    proxyCoreXray: "Xray (default, best compatibility)",
    proxyCoreSingBox: "sing-box (advanced DNS / routing)",
    proxyCoreRestartHint: "Changes apply when a profile starts. Running profiles must be restarted.",
    singBoxDnsEnable: "Enable sing-box DNS",
    singBoxDnsThroughProxy: "Send DNS queries through proxy_main",
    singBoxDnsStrategy: "DNS strategy",
    singBoxDnsServers: "Remote DNS servers, one per line",
    singBoxDnsHint: "These DoH queries are sent through proxy_main. Keeping the default public DoH resolvers gives sing-box Clash-like DNS ownership without browser local DNS leaks.",
